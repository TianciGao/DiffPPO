...
Each algorithm file also implements an algorithm factory function that
...
def algo_factory(algo_name, config, obs_key_shapes, ac_dim, device):
    ...
    algo_cls, algo_kwargs = factory_func(config.algo, config.observation, config, obs_key_shapes, ac_dim, device)
